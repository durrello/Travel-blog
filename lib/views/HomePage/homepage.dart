                          ...
                          return GridView.builder(
                              ...
                              gridDelegate:
                                  SliverGridDelegateWithFixedCrossAxisCount(
                                      ...
                                      crossAxisCount: 2),
                              itemBuilder: (context, index) {
                                PlaceModel placeModel = snapshot.data[index];
                                return GestureDetector(
                                    onTap: () {
                                      // Navigator.pushNamed(context, "/view");
                                      // MaterialPageRoute(
                                      ...
                                      Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (context) => new ViewDetails(
                                              placeTitle: placeModel.placeTitle,
                                              locationShort:
                                                  placeModel.locationShort,
                                              rating: placeModel.rating,
                                              description:
                                                  placeModel.description,
                                              duration: placeModel.duration,
                                              rateperpackage:
                                                  placeModel.rateperpackage,
                                              imgUrl: placeModel.imgUrl),
                                        ),
                                      );
                                    },
                                    child: TravelCard(
                                      imgUrl: placeModel.imgUrl.toString(),
                                      placeTitle:
                                          placeModel.placeTitle.toString(),
                                      // rating: placeModel.rating.toString(),
                                    ));
